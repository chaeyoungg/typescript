...
export default function List() {
  ...
  // const [data, setData] = useState([]); // useQuery에서 데이터 상태를 관리해주므로 필요없음

  const { isLoading, data } = useQuery<ApiRes<MultiItem<Post>> | undefined>({
    queryKey: [type, searchParams?.toString()], //캐시할 때 키 값
    queryFn: () => {
